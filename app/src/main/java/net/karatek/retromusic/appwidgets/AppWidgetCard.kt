...
import net.karatek.retromusic.service.MusicService.*
import net.karatek.retromusic.util.*
...
class AppWidgetCard : BaseAppWidget() {
	...
	override fun performUpdate(service: MusicService, appWidgetIds: IntArray?) {
		...
		if (imageSize == 0) {
			imageSize = service.resources.getDimensionPixelSize(net.karatek.retromusic.R.dimen.app_widget_card_image_size)
		}
		if (cardRadius == 0f) {
			cardRadius = service.resources.getDimension(net.karatek.retromusic.R.dimen.app_widget_card_radius)
		}
