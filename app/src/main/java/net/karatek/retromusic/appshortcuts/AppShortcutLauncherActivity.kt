...
package net.karatek.retromusic.appshortcuts

import android.app.Activity
import android.content.Intent
import android.os.Bundle
import net.karatek.retromusic.activities.SearchActivity
import net.karatek.retromusic.appshortcuts.shortcuttype.*
import net.karatek.retromusic.model.Playlist
import net.karatek.retromusic.model.smartplaylist.*
...
class AppShortcutLauncherActivity : Activity() {
	...
	companion object {
		const val KEY_SHORTCUT_TYPE = "net.karatek.retromusic.appshortcuts.ShortcutType"
