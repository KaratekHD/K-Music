...
package net.karatek.retromusic.appshortcuts.shortcuttype

import android.annotation.TargetApi
import android.content.*
import android.content.pm.ShortcutInfo
import android.os.*
import net.karatek.retromusic.appshortcuts.AppShortcutLauncherActivity
...
abstract class BaseShortcutType(internal var context: Context) {
	...
	companion object {
		internal const val ID_PREFIX = "net.karatek.retromusic.appshortcuts.id."
		val id: String
