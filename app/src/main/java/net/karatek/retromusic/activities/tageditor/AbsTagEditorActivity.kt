...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(net.karatek.retromusic.R.string.pick_from_local_storage),
            getString(net.karatek.retromusic.R.string.web_search),
            getString(net.karatek.retromusic.R.string.remove_cover)
        )
