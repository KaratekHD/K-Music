...
import net.karatek.retromusic.activities.base.AbsSlidingMusicPanelActivity
import net.karatek.retromusic.activities.tageditor.AbsTagEditorActivity
import net.karatek.retromusic.activities.tageditor.AlbumTagEditorActivity
import net.karatek.retromusic.adapter.album.HorizontalAlbumAdapter
import net.karatek.retromusic.adapter.song.SimpleSongAdapter
import net.karatek.retromusic.dialogs.AddToPlaylistDialog
import net.karatek.retromusic.dialogs.DeleteSongsDialog
import net.karatek.retromusic.extensions.ripAlpha
...
import net.karatek.retromusic.mvp.presenter.AlbumDetailsView
