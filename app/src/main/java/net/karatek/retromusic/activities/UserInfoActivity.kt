...
import net.karatek.retromusic.Constants.USER_PROFILE
...
import net.karatek.retromusic.util.Compressor
import net.karatek.retromusic.util.ImageUtil.getResizedBitmap
