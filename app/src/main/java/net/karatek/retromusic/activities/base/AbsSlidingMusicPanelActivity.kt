package net.karatek.retromusic.activities.base
...
import net.karatek.retromusic.fragments.MiniPlayerFragment
import net.karatek.retromusic.fragments.NowPlayingScreen
import net.karatek.retromusic.fragments.NowPlayingScreen.ADAPTIVE
import net.karatek.retromusic.fragments.NowPlayingScreen.BLUR
import net.karatek.retromusic.fragments.NowPlayingScreen.BLUR_CARD
import net.karatek.retromusic.fragments.NowPlayingScreen.CARD
import net.karatek.retromusic.fragments.NowPlayingScreen.CIRCLE
import net.karatek.retromusic.fragments.NowPlayingScreen.COLOR
import net.karatek.retromusic.fragments.NowPlayingScreen.FIT
import net.karatek.retromusic.fragments.NowPlayingScreen.FLAT
import net.karatek.retromusic.fragments.NowPlayingScreen.FULL
import net.karatek.retromusic.fragments.NowPlayingScreen.MATERIAL
import net.karatek.retromusic.fragments.NowPlayingScreen.NORMAL
import net.karatek.retromusic.fragments.NowPlayingScreen.PEAK
import net.karatek.retromusic.fragments.NowPlayingScreen.PLAIN
import net.karatek.retromusic.fragments.NowPlayingScreen.SIMPLE
import net.karatek.retromusic.fragments.NowPlayingScreen.TINY
import net.karatek.retromusic.fragments.base.AbsPlayerFragment
import net.karatek.retromusic.fragments.player.adaptive.AdaptiveFragment
import net.karatek.retromusic.fragments.player.blur.BlurPlayerFragment
import net.karatek.retromusic.fragments.player.card.CardFragment
import net.karatek.retromusic.fragments.player.cardblur.CardBlurFragment
import net.karatek.retromusic.fragments.player.circle.CirclePlayerFragment
import net.karatek.retromusic.fragments.player.color.ColorFragment
import net.karatek.retromusic.fragments.player.fit.FitFragment
import net.karatek.retromusic.fragments.player.flat.FlatPlayerFragment
import net.karatek.retromusic.fragments.player.full.FullPlayerFragment
import net.karatek.retromusic.fragments.player.material.MaterialFragment
import net.karatek.retromusic.fragments.player.normal.PlayerFragment
import net.karatek.retromusic.fragments.player.peak.PeakPlayerFragment
import net.karatek.retromusic.fragments.player.plain.PlainPlayerFragment
import net.karatek.retromusic.fragments.player.simple.SimplePlayerFragment
import net.karatek.retromusic.fragments.player.tiny.TinyPlayerFragment
import net.karatek.retromusic.helper.MusicPlayerRemote
import net.karatek.retromusic.model.CategoryInfo
import net.karatek.retromusic.util.DensityUtil
import net.karatek.retromusic.util.PreferenceUtil
import net.karatek.retromusic.views.BottomNavigationBarTinted
