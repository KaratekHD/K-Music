...
package net.karatek.retromusic.helper
...
object MusicPlayerRemote {
    ...
    fun playNext(song: Song): Boolean {
        if (musicService != null) {
            ...
            Toast.makeText(
                musicService,
                musicService!!.resources.getString(net.karatek.retromusic.R.string.added_title_to_playing_queue),
                Toast.LENGTH_SHORT
            ).show()
            return true
        }
    ...
    fun playNext(songs: ArrayList<Song>): Boolean {
        if (musicService != null) {
            ...
            val toast =
                if (songs.size == 1) musicService!!.resources.getString(net.karatek.retromusic.R.string.added_title_to_playing_queue) else musicService!!.resources.getString(
                    net.karatek.retromusic.R.string.added_x_titles_to_playing_queue,
                    songs.size
                )
