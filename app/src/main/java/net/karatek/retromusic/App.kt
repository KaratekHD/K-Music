...
package net.karatek.retromusic

import androidx.multidex.MultiDexApplication
import code.name.monkey.appthemehelper.ThemeStore
import code.name.monkey.appthemehelper.util.VersionUtils
import net.karatek.retromusic.R
import net.karatek.retromusic.appshortcuts.DynamicShortcutManager
import net.karatek.retromusic.dagger.DaggerMusicComponent
import net.karatek.retromusic.dagger.MusicComponent
